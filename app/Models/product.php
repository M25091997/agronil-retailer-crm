...
{
    protected $fillable = ['name', 'sku', 'slug', 'sort_description', 'category_id', 'category', 'sub_category_id', 'sub_category', 'child_category_id', 'child_category', 'brand_id', 'brand', 'disease_id', 'disease', 'tags', 'description', 'specification', 'other_information', 'unit_type_id', 'unit_type', 'base_unit_id', 'base_unit', 'is_active', 'top_selling', 'trending', 'featured', 'new_arrival', 'user_id', 'is_sale', 'thumnail_image', 'is_verified', 'hsn_code'];
