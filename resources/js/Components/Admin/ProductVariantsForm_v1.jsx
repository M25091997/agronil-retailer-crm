...
function ProductVariantsForm() {
    ...
    return (
        <>
                    ...
                    <Row>
                        <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Select
                                    ...
                                    onChange={(e) => handleVariantChange(variantIndex, 'base_unit_id', e.target.value)}
                                >
                        ...
                        <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Control
                                    ...
                                    onChange={(e) => handleVariantChange(variantIndex, 'original_price', e.target.value)}
                                />
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Control
                                    ...
                                    value={variant.kg_rate}
                                    onChange={(e) => handleVariantChange(variantIndex, 'kg_rate', e.target.value)}
                                />
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={2}>
                            <Form.Check
                                ...
                                onChange={(e) => handleVariantChange(variantIndex, 'is_bulk', e.target.checked)}
                            />
                        </Col>
                    </Row>
                            ...
                            <Row key={bulkIndex} className="pt-3">
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) =>
                                                handleBulkChange(variantIndex, bulkIndex, 'pieces_per_box', e.target.value)
                                            }
                                        />
                                    </Form.Group>
                                </Col>
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) =>
                                                handleBulkChange(variantIndex, bulkIndex, 'bulk_qty_range', e.target.value)
                                            }
                                        />
                                    </Form.Group>
                                </Col>
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) =>
                                                handleBulkChange(variantIndex, bulkIndex, 'bulk_price', e.target.value)
                                            }
                                        />
                                    </Form.Group>
                                </Col>
                                ...
                                <Col md={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) =>
                                                handleBulkChange(variantIndex, bulkIndex, 'total_box_price', e.target.value)
                                            }
                                        />
                                    </Form.Group>
                                </Col>
                                ...
                                <Col md={1} className="d-flex align-items-center">
                                    <Form.Check
                                        ...
                                        onChange={(e) =>
                                            handleBulkChange(variantIndex, bulkIndex, 'best_value', e.target.checked)
                                        }
                                    />
                                </Col>
            ...
            <Row className="mb-3">
                <Col md={2} >
                    <Button variant="info" className="btn-sm" onClick={addVariant}>
