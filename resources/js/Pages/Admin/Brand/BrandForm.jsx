...
export default function BrandForm({ brand = null, categories }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                ...
                response = await axiosClient.post(`/admin/brands/${brand.id}`, formData);
            } else {
                response = await axiosClient.post('/admin/brands', formData);
            }
    ...
    const validate = () => {
        ...
        if (!form.name?.trim()) temp.name = 'Brand name is required';
        if (!form.category_id) temp.category_id = 'Category is required';

        if (!isEditMode && !form.image)
            temp.image = 'Brand image is required';
    ...
    return (
        <AuthenticatedLayout>
            <PageHeader title="Brand's" menu="Product" />
            <div className="row">
                <div className="col-lg-6">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">Brand Details.</h4>
                        </div>
                        ...
                        <div className="card-body p-4">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <Link href="/admin/brands"> <button type="button" name="submitButton"
